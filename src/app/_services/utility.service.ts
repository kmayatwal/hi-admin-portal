...
export class UtilityService {
    ...
    getCurrentUser() {
        try {
            ...
            if (authObj !== null && authObj.access_token !== undefined
                && authObj.access_token !== null) {
                return authObj;
            } else {
                return null;
            }
    ...
    setUserPermission(userData) {
        try {
            localStorage.setItem('userPermission',JSON.stringify(userData));
        } catch (e) { }
    }
    getUserPermission() {
    ...
    removeUserPermission() {
        return localStorage.removeItem('userPermission');
    }
}
